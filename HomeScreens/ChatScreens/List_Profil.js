...
export default function List_Profil({navigation}) {
    ...
    const handleUpdate = (updateP)=>{
      const profilsRef = firebase.database().ref('users');
                    ...
                    if(id !== currentId){
                      return (
                        <View style={{flexDirection:'row',margin:10}}>
                          ...
                          <View  style={{flexDirection:'row',margin:10}}>
                          <Ionicons name="call" size={24} color="black" style={{marginRight:20}} />
                          <FontAwesome name="edit" size={24} color="black" style={{marginRight:20}}  />
